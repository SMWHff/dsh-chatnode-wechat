...
export declare function firstPromptLabel(session: Session): string;
/** 会话名称：真实标题优先，标题未生成（或服务不可用）时回退首条消息标签。 */
export declare function sessionName(node: WechatConversationNode, session: Session): string;
/** 状态消息统一前缀：`【名称 · id】`，名称与 id 均不省略。 */
export declare function sessionBadge(node: WechatConversationNode, session: Session): string;
